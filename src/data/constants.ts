...
const WECHAT = "微信";
const ZHIHU = "知乎";
const GITHUB_LINK = "https://github.com/guyingd/";
const TELEGRAM_LINK = "暂无";
const GMAIL_ADDRESS = "yingg9689@gmail.com";
const WECHAT_ACCOUNT = "guying_wx";

// 机器人
interface BotMenuData {
  readonly bot: string;
  readonly haitang: string;
}
