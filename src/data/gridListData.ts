...
const botGridList: Array<GridItemType> = [
  gridItem(botData.haitang, "/docs/bot", haitang),
];
...
export { frontendGridList, backendGridList, othersGridList, botGridList };
